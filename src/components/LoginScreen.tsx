            ...
            <div className="w-full md:w-7/12 flex flex-col justify-center px-8 md:px-24 relative bg-[#0D111D]">
                <div className="max-w-md w-full mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-400 text-sm">Don't have an account? <button onClick={onNavigateToRegister} className="text-white hover:underline cursor-pointer">Register</button></p>
                    </div>
                    ...
                    <form className="space-y-4">
                        ...
                        <div className="flex items-center justify-between mt-4">
                            <div className="flex items-center gap-2">
                                <input type="checkbox" id="remember" className="w-4 h-4 rounded bg-[#1A1F2E] border-gray-600 text-indigo-600 focus:ring-indigo-500" />
                    ...
                    <div className="relative my-8 text-center">
                        ...
                        <span className="relative bg-[#0D111D] px-2 text-xs text-gray-500 uppercase">Or log in with</span>
                    </div>
